...
export const gallery: GalleryPhoto[] = [
  {
    id: "anakin-hack-room",
    src: "/gallery/anakin-hack-room.jpg",
    alt: "Packed room at Anakin.io's hackathon — a few hundred builders.",
    caption: "Anakin Hack — packed builder room with the Anakin.io (YC S21) crew.",
    event: "Anakin Hack · Anakin.io",
    location: "Bengaluru",
    date: "May 2026",
    tag: "hackathon",
    aspect: "landscape",
  },
  {
    ...
    caption: "Heads-down at Anakin Hack — YC S21 builder day.",
    event: "Anakin Hack · Backstage",
    location: "Bengaluru",
    date: "May 2026",
    tag: "hackathon",
    aspect: "landscape",
  ...
  {
    id: "jared-friedman-yc",
    src: "/gallery/jared-friedman-yc.jpg",
    alt: "Priyanshu Gupta with Y Combinator partner Jared Friedman.",
    caption: "Pitched my idea to Jared Friedman at YC Startup School India.",
  ...
  {
    id: "vibecon-pitching",
    src: "/gallery/vibecon-pitching.jpg",
    alt: "Priyanshu pitching at VibeCon by Emergent, April 2026.",
    caption: "Pitched at VibeCon — Emergent's AI builder summit.",
    event: "VibeCon · Pitched",
    location: "Bengaluru",
    date: "Apr 2026",
    tag: "speaking",
    aspect: "landscape",
  ...
  {
    id: "vibecon-group",
    src: "/gallery/vibecon-group.jpg",
    alt: "VibeCon closing group photo — hands up, packed room.",
    caption: "Closing moment at VibeCon by Emergent — hands up, packed room.",
    event: "VibeCon · Closing",
    location: "Bengaluru",
    date: "Apr 2026",
    tag: "field",
    aspect: "landscape",
  ...
  {
    id: "vibecon-panel",
    src: "/gallery/vibecon-panel.jpg",
    alt: "Attending VibeCon — speakers Q&A on the floor.",
    caption: "On the floor at VibeCon — Emergent's AI builder summit.",
    event: "VibeCon · Floor",
    location: "Bengaluru",
    date: "Apr 2026",
    tag: "field",
  ...
  },
  {
    ...
    caption: "Attended Y Combinator Startup School India 2026 — selected, credited, in the room.",
  ...
  {
    id: "polaris-ecell-classroom",
    src: "/gallery/polaris-ecell-classroom.jpg",
    alt: "Polaris E-Cell team in a working session at the Polaris lecture hall.",
    caption: "The E-Cell crew between dealflow sessions — Polaris HQ.",
  ...
  {
    id: "polaris-ecell-lounge",
    src: "/gallery/polaris-ecell-lounge.jpg",
    alt: "Polaris E-Cell cohort photo in the campus lounge.",
    caption: "E-Cell cohort photo — off the floor, between rounds.",
    event: "Polaris E-Cell",
    location: "Polaris School of Technology, Bengaluru",
    date: "2025",
    tag: "organized",
